...
export const STAT_DEFS: StatDef[] = [
  ...
  { key: "physicalPen", label: "Phys Pen", color: "#d98a4d", axis: "left",
    get: (s) => s.stats.physicalPenetrationFlat * (1 + s.stats.physicalPenetrationPct), fmt: r0 },
  { key: "magicPen", label: "Magic Pen", color: "#4d8ad9", axis: "left",
  ...
  { key: "spellVampPct", label: "Spell Vamp %", color: "#b65be0", axis: "right", get: (s) => s.stats.spellVampPct, fmt: pct },
